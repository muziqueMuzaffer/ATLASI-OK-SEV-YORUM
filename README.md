bir adet trafik işaretleri modeli var, çift yönlü yol ve park yerini düzgün okumuyor.
bir adet trafik işareti modelini test eden kod, py. halinde olduğu için ikisini aynı klasörde çalıştırın
